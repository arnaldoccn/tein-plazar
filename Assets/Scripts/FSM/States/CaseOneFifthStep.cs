...
{
    public class CaseOneFifthStep : IState
    {
        ...
        public CaseOneFifthStep(CubeView cubeView)
        {
            ...
            if(!cubeView.audioSource.isPlaying && alreadyPlayed)
             {
                ...
                isPlaying = false;
                cubeView.stateMachine.TransitionTo(cubeView.stateMachine.caseOneSixthStep);
            }
        }
