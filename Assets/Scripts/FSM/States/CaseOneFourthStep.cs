...
{
    public class CaseOneFourthStep : IState
    {
        ...
        public CaseOneFourthStep(CubeView cubeView)
        {
            ...
            if(!cubeView.audioSource.isPlaying && alreadyPlayed)
             {
                ...
                isPlaying = false;
                cubeView.stateMachine.TransitionTo(cubeView.stateMachine.caseOneFifthStep);
            }
        }
