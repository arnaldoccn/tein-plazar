...
{
    public class CollaborationExplanationThreeState : IState
    {
        ...
        public CollaborationExplanationThreeState(CubeView cubeView)
        {
            ...
            if(!cubeView.audioSource.isPlaying && alreadyPlayed)
             {
                ...
                isPlaying = false;
                cubeView.stateMachine.TransitionTo(cubeView.stateMachine.collaborationExplanationFourState);
            }
        }
