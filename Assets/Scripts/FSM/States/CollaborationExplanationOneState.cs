...
{
    public class CollaborationExplanationOneState : IState
    {
        ...
        public CollaborationExplanationOneState(CubeView cubeView)
        {
            ...
            if(!cubeView.audioSource.isPlaying && alreadyPlayed)
             {
                ...
                isPlaying = false;
                cubeView.stateMachine.TransitionTo(cubeView.stateMachine.collaborationExplanationTwoState);
            }
        }
